...
## Team Members
- Yashaswi Tiwari **(Project Manager & QA)**
- Chisom Njoku (SQL/ETL Analyst)
- Tracy Odaro (Documentation)
- Danielle Aranha (Data Lead & SQL/ETL Analyst)
- Michael Okafor (•	Reporting Lead & SQL/ETL Analyst)
...
## Data Work Responsibilities - 4 Topic Areas
